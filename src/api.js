        ...
        return[
            {
                ...
                items: await fetchData(`/movie/now_playing?api_key=3b88845e949fdf7b792077a7a905048d&language=pt-BR`)
            },
            {
                slug:'2019-novembro',
                title:'Lançados em Novembro de 2020',
                items:await fetchData(`/discover/movie?api_key=${API_KEY}&language=pt-BR&primary_release_date.gte=2019-02-01&&primary_release_date.lte=2019-05-20&page=1`)
            }
        ]
    },
